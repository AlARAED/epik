            ...
            <div class="col-lg-4 col-md-6">
                <div class="addres-box">
                    <div style="border-right: 1px solid #51c9f3;">
                        <h5 class="title color_white">{{ $setting->title }}</h5>
                        <ul>
                            <li class="flex">
                                <i class="icon icon-location color_white "></i>
                                <p class="color_white">{{ $setting->address }}</p>

                            </li>
                            <li class="flex">
                                <i class="icon icon-phone color_white "></i>
                                <a href="#" class="color_white">{{ $setting->phone }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="wpc-weather-id">
                            <div id="wpc-weather" class="wpc-weather-1 medium">
                                <div class="now">
                                    ...
                                    <div class="time_temperature ">{{ round($current['main']['temp']) }}</div>
                                </div>
                            ...
                            <div class="widget_inner">
                                <div class="sc_socials sc_socials_type_icons sc_socials_shape_round sc_socials_size_tiny">
                                    <div class="sc_socials_item">
                                        ...
                                        @if($setting->fb!=null)
                                        <a href="{{ $setting->fb }}" target="_blank" class="social_icons social_facebook color_white">
                                    ...
                                    <div class="sc_socials_item">
                                        <a href="{{ $setting->inst}}" target="_blank" class="social_icons social_instagram-3 color_white">
                                            <span class="icon-instagram-3"></span>
                                        </a>
                                    </div>
                                    @endif

                                    @if($setting->wats!=null)
                                    <div class="sc_socials_item">
                                        <a href="{{ $setting->wats }}" target="_blank" class="social_icons social_foursquare whatsapp-link">
