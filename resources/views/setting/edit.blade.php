          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input name="address" value="{{ $setting->address }}" type="text" id="address" class="form-control">
              </div>
               <div class="form-group">
                <label for="inputName">telephone</label>
                <input name="telephone" value="{{ $setting->telephone }}" type="text" id="telephone" class="form-control">
              </div>
